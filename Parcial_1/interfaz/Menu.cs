...
namespace Parcial_1.interfaz
{
    public class Menu
    {
            ...
            while (!salir)
            {
                ...
                switch (opcion)
                {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        OperacionesEntreGrupos();
                        break;
                    case "5":
                        salir = true;
                        break;
                    default:
                        Console.WriteLine("Opción no válida. hacer el favor de seleccione una opción válida.");
        ...
        public void OperacionesEntreGrupos()
        {
